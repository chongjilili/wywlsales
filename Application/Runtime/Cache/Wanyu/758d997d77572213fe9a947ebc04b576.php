...
<div class="wymain">
    ...
    <div class="spebox">
        <form class="form-horizontal" role="form" id="peform" action="<?php echo U('Email/change');?>">




            <div class="form-group">
                <label for="host" class="col-sm-3 control-label">SMTP 服务器</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="host" placeholder="SMTP 服务器" name="host" value="<?php echo ($smtp["host"]); ?>">
                </div>
            </div>

            <div class="form-group">
                <label for="port" class="col-sm-3 control-label">SMTP服务器的端口号</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="port" placeholder="SMTP服务器的端口号" name="port" value="<?php echo ($smtp["port"]); ?>">
                </div>
            </div>


            <div class="form-group">
                <label for="username" class="col-sm-3 control-label">SMTP服务器用户名</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="username" placeholder="SMTP服务器用户名" name="username" value="<?php echo ($smtp["username"]); ?>">
                </div>
            </div>

            <div class="form-group">
                <label for="password" class="col-sm-3 control-label">SMTP服务器密码</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="password" placeholder="SMTP服务器密码" name="password" value="<?php echo ($smtp["password"]); ?>">
                </div>
            </div>


            <div class="form-group">
                <label for="fromemail" class="col-sm-3 control-label">发件人EMAIL</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="fromemail" placeholder="发件人EMAIL" name="fromemail" value="<?php echo ($smtp["fromemail"]); ?>">
                </div>
            </div>

            <div class="form-group">
                <label for="fromname" class="col-sm-3 control-label">发件人名称</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="fromname" placeholder="发件人名称" name="fromname" value="<?php echo ($smtp["fromname"]); ?>">
                </div>
            </div>
