...
/*
 * 和array_column一样， 返回输入数组中某个单一列的值。
 * @param $array 必需。规定要使用的多维数组（记录集）。
 * @param $column_key  必需。需要返回值的列。
 *
 * **/
function getarraycolumn($array , $column_key ){
